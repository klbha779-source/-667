...
export default function App() {
  ...
  return (
    <div 
      className={
        isLandscape 
          ? "fixed top-1/2 left-1/2 w-[100vh] h-[100vw] -translate-x-1/2 -translate-y-1/2 rotate-90 overflow-y-auto overflow-x-hidden bg-gray-50" 
          : "min-h-screen bg-gray-50 overflow-x-hidden"
      }
    >
      <div className="min-h-full font-[Cairo] text-gray-900 pb-24 flex flex-col">
        {/* Header */}
